...
layer::layer(const double kkappa) : mu(Parameters::smooth_params[0]), rho(Parameters::smooth_params[1])
{
	kappa = kkappa;
	_equations = {
...
layer::layer(double kkappa, const std::vector<double>& points, const std::vector<double>& rho0, const std::vector<double>& rho1)
: mu(Parameters::smooth_params[0]), rho(Parameters::smooth_params[1])
{
	...
	Parameters::piecewise_linear_params = std::vector<std::vector<double>>(points.size(), std::vector<double>(2));
